...
In vscode, open the "v5" folder and open a terminal in it. You should see a green "(.venv)" text appear after a second. This is how you know that the script worked. Also 
...
- in windows: open 'device manager'
  - scroll to "Ports (COM & LPT)"
  - look for "USB Serial Port (COMXXX)"
  - Note the number you have instead of XXX
- Go into the 'app.py' script
- Change the SERIAL_PORT   = 'COM4' line to the correct one you just found
...
- In your web-browser of choice, open localhost:5000
