...
const float PRESSURE_OFFSETS[3] = {-40, -40, -40}; // PSI
...
#define SERVO_CLOSED 975 // Tested by Etan 3-26-26
#define SERVO_OPEN   1900 // Tested by Etan 3-26-26 (only one SABV though)
