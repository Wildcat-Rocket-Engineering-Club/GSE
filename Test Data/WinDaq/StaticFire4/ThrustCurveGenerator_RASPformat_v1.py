...
givenImpulse = 3148.14 # Reference... Calculated impulse from the thrustImpulseAnalysis python file

diameterInches = 4 # motor diameter

caseLengthInches = 12 # motor length

propMass_lbs = 7 # propellant mass (INCLUDE FUEL AND OXIDIZER IN THIS!)
...
shorthandname = 'ThrustVsTime_001' # Source CSV file name

sourcePath = 'U:\Documents\Documents\School\Clubs\WREC\Data\WinDaq\StaticFire4' # Source folder

savePathStr = "U:\Documents\Documents\School\Clubs\WREC\Data\WinDaq\StaticFire4\simfiles" # Output folder
