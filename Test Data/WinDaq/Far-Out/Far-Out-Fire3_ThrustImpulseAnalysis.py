...
fileName1 = r'u:\Documents\Documents\School\Clubs\WREC\Data\WinDaq\Far-Out\FarFire3-Trimmed2.csv'
...
#plt.xticks(np.arange(1260, 1375, 10))
...
filePath = "U:\Documents\Documents\School\Clubs\WREC\Data\WinDaq\Far-Out\Graphs-Fire3\WholeThing"
...
# and update this image name to the next version
fileName = "BurnGraph"
filePath = "U:\Documents\Documents\School\Clubs\WREC\Data\WinDaq\Far-Out\Graphs-Fire3\Burn"
output_file = os.path.join(filePath, fileName)
...
print("FAR-OUT Fire 3 Thrust and Impulse Analysis")
pl()
...
ax1.set_title('Far-Out Fire 3 Thrust')
ax1.set_ylabel('Thrust (N)')
ax1.set_ylim(400, max(thrust_newtons) + 50)
...
filePath = "U:\Documents\Documents\School\Clubs\WREC\Data\WinDaq\Far-Out\Graphs-Fire3\ThrustImpulse"
output_file = os.path.join(filePath, fileName)
i = 1
while True:
    fileName = output_file + str(i) + '.png'
...
filePath = "U:\Documents\Documents\School\Clubs\WREC\Data\WinDaq\Far-Out\ThrustCurve_CSVs-Fire3"
output_file = os.path.join(filePath, fileName)
